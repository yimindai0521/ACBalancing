...
if(!require(WeightIt, quietly = TRUE)){ install.packages("WeightIt")}
if(!require(MASS, quietly = TRUE)){ install.packages("MASS")}
if(!require(CBPS, quietly = TRUE)){ install.packages("CBPS")}
if(!require(ATE.ncb, quietly = TRUE)){ devtools::install_github("raymondkww/ATE.ncb")}
if(!require(ACBalancing, quietly = TRUE)){ devtools::install_github("yimindai0521/ACBalancing")}
...
We repeat 1 time. If you want to simulate more data, please modify `mainf1(1)` to `mainf1(200)`.
